    ...
    <div className="min-h-screen bg-white text-slate-800">
      ...
      <main className="max-w-3xl mx-auto px-4 py-10 md:py-14 space-y-8 text-sm md:text-base leading-relaxed">
        ...
        <section className="space-y-3">
          <h2 className="text-lg font-bold text-brand-navy">1. Not legal or professional advice</h2>
          <p className="text-slate-600">
        ...
        <section className="space-y-3">
          <h2 className="text-lg font-bold text-brand-navy">2. Consultations & proposals</h2>
          <p className="text-slate-600">
        ...
        <section className="space-y-3">
          <h2 className="text-lg font-bold text-brand-navy">3. Acceptable use</h2>
          <p className="text-slate-600">
        ...
        <section className="space-y-3">
          <h2 className="text-lg font-bold text-brand-navy">4. Intellectual property</h2>
          <p className="text-slate-600">
        ...
        <section className="space-y-3">
          <h2 className="text-lg font-bold text-brand-navy">5. Third-party links</h2>
          <p className="text-slate-600">
        ...
        <section className="space-y-3">
          <h2 className="text-lg font-bold text-brand-navy">6. Disclaimers</h2>
          <p className="text-slate-600">
        ...
        <section className="space-y-3">
          <h2 className="text-lg font-bold text-brand-navy">7. Limitation of liability</h2>
          <p className="text-slate-600">
        ...
        <section className="space-y-3">
          <h2 className="text-lg font-bold text-brand-navy">8. Governing law</h2>
          <p className="text-slate-600">
        ...
        <section className="space-y-3">
          <h2 className="text-lg font-bold text-brand-navy">9. Contact</h2>
          <p className="text-slate-600">
            <a href="mailto:igtechgh@gmail.com" className="text-brand-green underline font-medium">
              igtechgh@gmail.com
            </a>
            {" · "}
            <a href="tel:+233530710628" className="text-brand-green underline font-medium">
              +233 530 710 628
            </a>
          </p>
        </section>
